defmodule Tilde.Runtime.Markdown do
  @moduledoc """
  ...
  through `:tilde, :markdown_backend` and defaults to `Tilde.Runtime.Markdown.Provider.MDEx`.
  """

  @default_backend Tilde.Runtime.Markdown.Provider.MDEx
